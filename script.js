...
window.addEventListener("load" , function() {
 ...
 // Set listedPlanetsResponse equal to the value returned by calling myFetch()
     ...
     const lcPlanet = pickPlanet(listedPlanets);
     addDestinationInfo(document, lcPlanet.name, lcPlanet.diameter, lcPlanet.star, lcPlanet.distance, lcPlanet.moons, lcPlanet.image);
      });
});